	...
	{ // Tests against a 'recent' chain definition
		...
		for i, tt := range []struct {
			...
			{ // Another ErrInsufficientFunds, this one to ensure that feecap/tip of max u256 is allowed
				...
				want: "could not apply tx 0 [0xd82a0c2519acfeac9a948258c47e784acd20651d9d80f9a1c67b4137651c3a24]: insufficient funds for gas * price + value: address xdc71562b71999873DB5b286dF957af199Ec94617F7 required balance exceeds 256 bits",
			},
		}[8:] {
