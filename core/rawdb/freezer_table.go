...
func newTable(path string, name string, readMeter, writeMeter *metrics.Meter, sizeCounter *metrics.Counter, disableSnappy bool) (*freezerTable, error) {
...
func newCustomTable(path string, name string, readMeter, writeMeter *metrics.Meter, sizeCounter *metrics.Counter, maxFilesize uint32, noCompression bool) (*freezerTable, error) {
