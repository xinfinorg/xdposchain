...
func testFastSyncDisabling(t *testing.T, protocol int) {
	...
	go pmFull.handle(pmFull.newPeer(protocol, p2p.NewPeer(discover.NodeID{}, "empty", nil), io2, pmFull.txpool.Get))
	go pmEmpty.handle(pmEmpty.newPeer(protocol, p2p.NewPeer(discover.NodeID{}, "full", nil), io1, pmEmpty.txpool.Get))
