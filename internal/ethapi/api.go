...
// transaction hashes.
func RPCMarshalBlock(b *types.Block, inclTx bool, fullTx bool, ctx context.Context) (map[string]interface{}, error) {
...
func (s *PublicBlockChainAPI) rpcOutputBlock(b *types.Block, inclTx bool, fullTx bool, ctx context.Context) (map[string]interface{}, error) {
	fields, err := RPCMarshalBlock(b, inclTx, fullTx, ctx)
	if err != nil {
		return nil, err
	}
